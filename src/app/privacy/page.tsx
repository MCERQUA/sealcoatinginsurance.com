          ...
          <FadeIn>
            ...
            <div className="prose-warm mt-8">
              ...
              <ul>
                ...
                <li>Information about your sealcoating operation needed to quote insurance (crew size, equipment value including tanks and spray systems, coating types used, annual revenue, payroll, job sizes, loss history)</li>
